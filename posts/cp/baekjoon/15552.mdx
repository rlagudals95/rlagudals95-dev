...
[10950 A+B - 3 문제](https://rlagudals95.github.io/TIL/algorithm/baekjoon/10950.html)와 유사하다. 하지만 이 문제에서는 ‘빠른’ 출력을 방식을 요구한다. 10950 번 문제에서는 for문 내에서 직접 출력하는 방식이었는데, 문제에서 이 방식은 출력할 때마다 시간 초과가 날 수 있다고 한다.
